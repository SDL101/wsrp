    ...
    <nav class="side-nav">
      ...
      <div class="nav-links">
        ...
        <a href="#" class="nav-link"
          ><i class="fas fa-exchange-alt"></i> Accounts</a
        >
        <a href="#" class="nav-link"
          ><i class="fas fa-file-invoice-dollar"></i>Tasks</a
        >
        <a href="#" class="nav-link"
          ><i class="fas fa-piggy-bank"></i>Branches</a
        >
        <a href="#" class="nav-link"
          ><i class="fas fa-chart-line"></i>Internal Feed</a
        >
      </div>
    </nav>
